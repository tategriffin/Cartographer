...
namespace Cartographer.Mappers
{
    internal abstract class ClassMapper
    {
        ...
        private List<StatementSyntax> BuildSourceToTargetMappingStatements(INamedTypeSymbol sourceSymbol, string sourceVariableName, INamedTypeSymbol targetSymbol, string targetVariableName)
        {
